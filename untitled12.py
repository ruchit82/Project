...
def main():
    ...
    menu = ["Register Helper", "Search Helpers", "About"]
    choice = st.sidebar.selectbox("Select an option", menu)

    if choice == "Register Helper":
        register_helper()
    elif choice == "Search Helpers":
        search_helpers()
    elif choice == "About":
        st.write("This is a simple system to register and search for house helpers. The registered data is stored in an Excel file.")
